print('Model_no_adjustments(train_data, test_data, parameters, number_of_neighbours = 5,run_name = None, save_name =None, save_results = False, save_directory=C:\\Users\\1roks\\Documents\\FMF\\Matematika z računalnikom\\Project\\Data\\Modeling results\\):')
...
def Model_no_adjustments(train_data, test_data, parameters, number_of_neighbours = 5,run_name = None, save_name =None, save_results = False, save_directory="C:\\Users\\1roks\\Documents\\FMF\\Matematika z računalnikom\\Project\\Data\\Modeling results\\"):
    ...
    if save_results:
        ...
        with pd.ExcelWriter(output_directory) as writer: 
            ...
            Model_metrics = Metrics(Model_results,run_name ,"ocena",parametri)
